...
if ($_SERVER['HTTP_HOST'] === 'localhost' || $_SERVER['HTTP_HOST'] === '127.0.0.1') {
    $host = 'localhost';
    $dbname = 'atox_db'; // اسم دیتابیسی که گفتی
    $user = 'root';      // نام کاربری پیش‌فرض لارگون و زمپ
    $pass = '';          // رمز عبور پیش‌فرض لوکال که خالی است
} else {
    $host = 'localhost';
    $dbname = 'atoxcomp_simpleblog';
    $user = 'atoxcomp_simpleblog'; 
    $pass = 'nviubdfsnibvnd430843bbivdshughdghdfhdfh12223ff'; 
}
